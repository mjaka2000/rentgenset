                            ...
                            <form action="<?= base_url('admin/proses_update_service_genset'); ?>" method="post" role="form">
                                <?php foreach ($list_data as $d) { ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input readonly type="text" name="kode_genset" class="form-control" id="kode_genset" placeholder="Nomor Genset" value="<?= $d->kode_genset; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="nama_genset" class="form-label">Nama Genset</label>
                                        <input readonly type="text" name="nama_genset" class="form-control" id="nama_genset" value="<?= $d->nama_genset; ?>">
                                    </div>
                                    <div class="form-group">
