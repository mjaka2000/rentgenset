            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><i class="fa fa-car mr-2"></i>Data Mobil</h3>
                    </div>
                    <div class="box-body">
                                ...
                                ?>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href="<?= base_url('admin/update_data_mobil/' . $dt->id); ?>" type="button" class="btn btn-sm btn-info" name="btn_edit"><i class="fa fa-edit mr-2"></i></a>
                                                <a href="<?= base_url('admin/hapus_mobil/' . $dt->id); ?>" type="button" class="btn btn-sm btn-danger btn-delete" name="btn_delete"><i class="fa fa-trash mr-2"></i></a>
