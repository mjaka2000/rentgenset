                ...
                <div class="container">
                    <div class="box box-primary" style="width:50%;margin:auto">
                        <div class="box-header">
                            <h3 class="box-title"><i class="nav-icon fa fa-plus-circle mr-2"></i>Tambah Mobil</h3>
                        </div>
                        <div class="box-body">
                            ...
                            <form action="<?= base_url('admin/proses_tambah_mobil'); ?>" method="post" role="form" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pajak" class="form-control form_datetime" id="pajak" placeholder="Pajak" required>
                                </div>
                                <div class="form-group">
                                    <label for="stnk" class="form-label">STNK</label>
                                    <input type="text" name="stnk" class="form-control form_datetime" id="stnk" placeholder="STNK" required>
                                </div>
                                <div class="form-group">
